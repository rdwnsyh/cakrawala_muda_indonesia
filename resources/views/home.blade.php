        ...
        <div class="md:flex">
          ...
          <div class="md:w-3/5 p-8 md:p-12">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <a href="#"
                class="group flex-1 inline-flex items-center justify-center gap-3 bg-white text-blue-700 px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
              ...
              <a href="{{ route('programs.show', $ongoingProgramItem->slug ?? '#') }}"
                class="group flex-1 inline-flex items-center justify-center gap-3 bg-white/20 backdrop-blur-lg border-2 border-white/30 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-blue-700 hover:scale-105 transition-all duration-300">
                <svg class="w-6 h-6 group-hover:rotate-12 transition-transform" fill="none"
                  stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<div id="our-program" class="py-20 bg-gray-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative">
      <!-- Carousel Container -->
      <div class="overflow-x-auto scroll-smooth snap-x snap-mandatory no-scrollbar cursor-grab active:cursor-grabbing"
        id="program-carousel">
        <div class="flex gap-6 pb-8 px-4 md:px-0 -mx-4 md:mx-0">
          <!-- Card 1: Jelajah Cakrawala Muda -->
          <div class="flex-shrink-0 snap-center w-full md:w-1/2 lg:w-1/3 px-4 md:px-0">
            <div
              class="group bg-white rounded-2xl shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              ...
              <div class="p-6">
                <h3
                  ...
                  Jelajah Cakrawala Muda
                </h3>
                <div class="pt-4 border-t border-gray-100 text-center">
                  <a href="{{ route('programs.index', ['jenis' => 'Jelajah Cakrawala Muda']) }}"
                    class="group/btn inline-flex items-center gap-2 text-blue-600 font-bold hover:text-blue-700 transition-colors mx-auto">
                    <span>Detail</span>
          ...
          <!-- Card 2: Cakrawala Volunteering on the Weekend (Coming Soon) -->
          <div class="flex-shrink-0 snap-center w-full md:w-1/2 lg:w-1/3 px-4 md:px-0">
            <div
              class="group bg-white rounded-2xl shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1 relative">
              <!-- Coming Soon Badge -->
              ...
              <div class="relative h-48 overflow-hidden opacity-75">
                <div
                  class="w-full h-full bg-gradient-to-r from-green-500 to-emerald-600 flex items-center justify-center">
                  <svg class="w-16 h-16 text-white opacity-50" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
                      stroke-width="2"
              ...
              <div class="p-6">
                <h3
                  class="text-xl font-bold text-gray-900 mb-4 group-hover:text-blue-600 transition-colors text-center">
                  Cakrawala Volunteering on the Weekend
                </h3>
                <div class="pt-4 border-t border-gray-100 text-center">
                  <button disabled
                    class="inline-flex items-center gap-2 text-gray-400 font-bold cursor-not-allowed mx-auto">
                    <span>Detail</span>
                    <svg class="w-5 h-5"
                      fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round"
          ...
          <!-- Card 3: Sehari Jadi Volunteer (Coming Soon) -->
          <div class="flex-shrink-0 snap-center w-full md:w-1/2 lg:w-1/3 px-4 md:px-0">
            <div
              class="group bg-white rounded-2xl shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1 relative">
              <!-- Coming Soon Badge -->
              ...
              <div class="relative h-48 overflow-hidden opacity-75">
                <div
                  class="w-full h-full bg-gradient-to-r from-purple-500 to-pink-600 flex items-center justify-center">
                  <svg class="w-16 h-16 text-white opacity-50" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
                      stroke-width="2"
      ...
      <div class="flex justify-center gap-2 mt-8">
        <div class="w-2 h-2 rounded-full bg-blue-600 transition-all duration-300 dot-indicator w-8"></div>
        <div class="w-2 h-2 rounded-full bg-gray-300 transition-all duration-300 dot-indicator"></div>
        <div class="w-2 h-2 rounded-full bg-gray-300 transition-all duration-300 dot-indicator"></div>
      </div>
    </div>
