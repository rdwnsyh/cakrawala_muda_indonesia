        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-48">
            <div class="text-center space-y-8">
                ...
                <div class="animate-fadeInUp">
                    <span
                        class="inline-flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-lg rounded-full text-sm font-semibold border border-white/20">
                        ...
                        <div class="md:flex">
                            ...
                            <div class="md:w-3/5 p-8 md:p-12">
                                ...
                                <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">
                                    {{ $ongoingProgramItem->nama_program }}</h3>
            ...
            @if ($jenisPrograms->count() > 0)
                <div class="relative">
                    ...
                    <div class="overflow-x-auto scroll-smooth snap-x snap-mandatory no-scrollbar cursor-grab active:cursor-grabbing"
                        id="program-carousel">
                        <!-- Tambah padding kiri-kanan + margin negatif untuk kompensasi -->
                                    ...
                                    <div
                                        ...
                                        <div class="relative h-48 overflow-hidden">
                                            @if ($jenis->poster_jenis_program)
                                                <img src="{{ asset('storage/' . $jenis->poster_jenis_program) }}"
                                                    alt="{{ $jenis->jenis_program }}"
                                        ...
                                        <div class="p-6">
                                            ...
                                            <div class="pt-4 border-t border-gray-100 text-center">
                                                <a href="{{ route('programs.index', ['jenis' => $jenis->jenis_program]) }}"
                    ...
                    <div class="flex justify-center gap-2 mt-8">
                        ...
                        @for ($i = 0; $i < $slidesCount; $i++)
                            <div class="w-2 h-2 rounded-full bg-gray-300 transition-all duration-300 dot-indicator"
                                data-index="{{ $i }}"></div>
                        @endfor
                    </div>
                </div>
